...
%   Global feature parameters 8
params.t_features = {
    ...struct('getFeature',@get_colorspace, 'fparams',grayscale_params),...  % Grayscale is not used as default默认不使用灰度
    struct('getFeature',@get_fhog,'fparams',hog_params),...
};
params.t_global.cell_size = 4;                  % Feature cell size
params.t_global.cell_selection_thresh = 0.75^2; % Threshold for reducing the cell size in low-resolution cases  0.5625
...
%   Learning parameters
params.learning_rate   = 0.013;       % learning rate,init=0.13,the paper is 0.0125  un
